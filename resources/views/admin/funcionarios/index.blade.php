...
<div class="content">
    @can('funcionario_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.funcionarios.create') }}">
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Funcionario">
                        <thead>
                            <tr>
                                <th width="10">
...
@can('funcionario_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.funcionarios.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.funcionarios.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'n_identificacion', name: 'n_identificacion' },
{ data: 'nombre', name: 'nombre' },
{ data: 'genero', name: 'genero' },
{ data: 'f_nacimiento', name: 'f_nacimiento' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Funcionario').DataTable(dtOverrideGlobals);
